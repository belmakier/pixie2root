...
namespace PIXIE {
  struct Mask {
    ...
    unsigned int operator() (unsigned int data) {
  ...
  public:
    ...
    //Trace measurements
    std::vector<PIXIE::Trace::Measurement> trace_meas;
    bool good_trace;
  ...
  public:
    ...
    int print() const;
    int read(FILE *fpr, Experiment_Definition &definition, uint16_t *outTrace=NULL);
